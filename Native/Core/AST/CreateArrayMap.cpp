...
namespace Fabric
{
  namespace AST
  {
    FABRIC_AST_NODE_IMPL( CreateArrayMap );
    
    RC::ConstHandle<CreateArrayMap> CreateArrayMap::Create(
    ...
    {
      return new CreateArrayMap( location, input, operatorName, shared );
    }
    ...
    void CreateArrayMap::appendJSONMembers( JSON::ObjectEncoder const &jsonObjectEncoder, bool includeLocation ) const
    {
    ...
    void CreateArrayMap::registerTypes( RC::Handle<CG::Manager> const &cgManager, CG::Diagnostics &diagnostics ) const
    {
